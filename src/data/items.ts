...
const LISTA: readonly Item[] = [
  ...
  { id: 'cristal_solar', nome: 'Cristal Solar', preco: 0, emBatalha: false, chave: true,
    efeito: { k: 'nenhum' },
    descricao: 'Cristal que guarda a luz do dia e brilha sozinho à noite. A forquilha acha.' },
  ...
  { id: 'mapa_luz', nome: 'Mapa da Cidade do Sol', preco: 0, emBatalha: false, chave: true,
    efeito: { k: 'nenhum' },
    descricao: 'A Cidade do Sol, o jardim e o pico, em tinta dourada. Com ele, o Mapa do Mundo mostra a planta de cada lugar dela.' },
